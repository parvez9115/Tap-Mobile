(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["add-products-add-products-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppAddProductsAddProductAddProductComponentHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppAddProductsAddProductsPageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppAddProductsAddProductAddProductComponentScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppAddProductsAddProductAddProductComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var AddProductComponent = /*#__PURE__*/function () {
        function AddProductComponent(commonService, ajaxService, modalController, formBuilder) {
        ...
        _createClass(AddProductComponent, [{
          ...
          value: function submit() {
            ...
            var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["ServerUrl"].live + "/product/productsave";
            var data;
            ...
            if (!this.value) {
              if (this.productImg.queue.length != 0) {
                data = {
                  "productid": "",
                  "brandname": this.products.value.brandName,
                  "productname": this.products.value.productName,
                  "copnumber": this.products.value.copNumber,
                  "copvalidtill": this.products.value.copValidtill.slice(0, 10),
                  "tagnumber": "",
                  "productImage": "",
                  "status": true,
              ...
              if (this.productImg.queue.length == 0) {
                var _url = src_environments_environment__WEBPACK_IMPORTED_MODULE_7__["ServerUrl"].live + "/product/productedit";
                ...
                var _testData = new FormData();

                _testData.append("productimage", this.productImg.queue[0]._file);

                _testData.append("data", JSON.stringify(data));

                this.ajaxService.ajaxPostWithFile(url, _testData).subscribe(function (res) {
                  if (res) {
                    _this.commonService.dismissLoader();
      ...
      AddProductComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        "./node_modules/raw-loader/dist/cjs.js!./src/app/add-products/add-product/add-product.component.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./add-product.component.scss */
        "./src/app/add-products/add-product/add-product.component.scss"))["default"]]
      })], AddProductComponent);
      /***/
    },
    ...
    /***/
    function srcAppAddProductsAddProductsRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _add_products_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./add-products.page */
    ...
    /***/
    function srcAppAddProductsAddProductsModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _add_products_routing_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./add-products-routing.module */
      "./src/app/add-products/add-products-routing.module.ts");
      /* harmony import */


      var _add_products_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./add-products.page */
      "./src/app/add-products/add-products.page.ts");
      /* harmony import */
      ...
      AddProductsPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], ng2_file_upload__WEBPACK_IMPORTED_MODULE_4__["FileUploadModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["IonicModule"], _add_products_routing_module__WEBPACK_IMPORTED_MODULE_6__["AddProductsPageRoutingModule"], _shared_module_shared_module__WEBPACK_IMPORTED_MODULE_8__["SharedModule"]],
    ...
    /***/
    function srcAppAddProductsAddProductsPageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppAddProductsAddProductsPageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var AddProductsPage = /*#__PURE__*/function () {
        function AddProductsPage(commonService, ajaxService, modalController, platform) {
        ...
        _createClass(AddProductsPage, [{
          ...
          value: function getDatas() {
            ...
            this.commonService.presentLoader();
            var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["ServerUrl"].live + "/product/getAllProduct";
          ...
          value: function update(selectedCard) {
            ...
            this.commonService.presentLoader();
            var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["ServerUrl"].live + "/product/productstatus";
            var data = {
          ...
          value: function updateFilter(event) {
            if (event.target.value != "") {
              ...
              var temp = this.memberList.filter(function (d) {
                if (d.brandname.toLowerCase().indexOf(val) !== -1) return d.brandname.toLowerCase().indexOf(val) !== -1;else if (d.productname.toLowerCase().indexOf(val) !== -1) return d.productname.toLowerCase().indexOf(val) !== -1;else if (d.productid.toString().toLowerCase().indexOf(val) !== -1) return d.productid.toString().toLowerCase().indexOf(val) !== -1;else if (d.copnumber.toLowerCase().indexOf(val) !== -1) return d.copnumber.toLowerCase().indexOf(val) !== -1; // else if (d.mobile1.toLowerCase().indexOf(val) !== -1)
      ...
      AddProductsPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-add-products',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./add-products.page.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/add-products/add-products.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./add-products.page.scss */
        "./src/app/add-products/add-products.page.scss"))["default"]]
      })], AddProductsPage);
      /***/
    }
  }]);
})();
//# sourceMappingURL=add-products-add-products-module-es5.js.map