(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["dashboard-dashboard-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppTestPdfTestPdfPageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function srcAppDashboardDashboardModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _shared_module_shared_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ../shared-module/shared.module */
      "./src/app/shared-module/shared.module.ts");
      /* harmony import */


      var _test_pdf_test_pdf_page__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ../test-pdf/test-pdf.page */
      "./src/app/test-pdf/test-pdf.page.ts");
      /* harmony import */


      var _dealer_dealer_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ./dealer/dealer.component */
      ...
      DashboardPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], _shared_module_shared_module__WEBPACK_IMPORTED_MODULE_7__["SharedModule"], _dashboard_routing_module__WEBPACK_IMPORTED_MODULE_5__["DashboardPageRoutingModule"]],
    ...
    function srcAppDashboardDashboardPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var DashboardPage = /*#__PURE__*/function () {
        function DashboardPage(menuController, ajaxService, storage, commonService, platform) {
        ...
        _createClass(DashboardPage, [{
            ...
            this.storage.get("login").then(function (body) {
              ...
              _this2.ajaxService.ajaxPostWithBody(url, body).subscribe(function (res) {
                ...
                if (res != null && res != "") {
                  ...
                  _this2.storage.set("loginRes", JSON.stringify(res)).then(function (res) {
                    if (_this2.commonService.isLoading) _this2.commonService.dismissLoader();

                    _this2.commonService.updateLoginInfo(messagingServiceData);
                  });
                }
              });
            });
          ...
          value: function getLoginUserList() {
            ...
            this.storage.get('loginRes').then(function (result) {
              ...
              _this3.page = result["role"]["roleName"];
              var body = result;

              if (_this3.page != "Dealer" && _this3.page != "RTO") {
                var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["ServerUrl"].live + "/dashboard/user/list";

                _this3.commonService.presentLoader();

                _this3.ajaxService.ajaxPostWithBody(url, body).subscribe(function (res) {
                  // console.log(res)
                  // res.forEach(element => {
                  // });
                  _this3.member = res;

                  _this3.storage.set("dashboardResult", JSON.stringify(res)).then(function (res) {
                    _this3.commonService.dismissLoader();
                  });

                  _this3.pdfTitle = ["User ID", "Role", "Name", "Email", "Address", "Contact"];

                  for (var i = 0; i < _this3.member.length; i++) {
                    _this3.pdfData.push([res[i].userId, res[i].role.roleName, res[i].name, res[i].email, res[i]['addressLine'] + ',' + res[i]['city'] + ',' + res[i]['state'] + ',' + res[i]['pincode'], res[i].mobile1]);
                  }
                });
              } else {
                var _url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["ServerUrl"].live + "/dashboard/certificate/list";

                _this3.commonService.presentLoader();

                _this3.ajaxService.ajaxPostWithBody(_url, body).subscribe(function (res) {
                  // console.log(res)
                  _this3.member = res;
                  ...
                  _this3.pdfTitle = ["Certificate id", "Registration no", "Name", "Vehicle Type", "Vehicle Modal", "Rto status"];

                  for (var i = 0; i < _this3.member.length; i++) {
                    _this3.pdfData.push([res[i].certificateId, res[i].registrationNumber, res[i].ownerName, res[i].vehicleMake, res[i].vehicleModel, res[i].rtoStatus]);
                  }
                });
              }
            });
    ...
    /***/
    function srcAppTestPdfTestPdfPageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppTestPdfTestPdfPageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "TestPDFPage", function () {
        return TestPDFPage;
      });
      /* harmony import */
      ...
      var TestPDFPage = /*#__PURE__*/function () {
        function TestPDFPage() {
          _classCallCheck(this, TestPDFPage);
        }

        _createClass(TestPDFPage, [{
          key: "printDiv",
          value: function printDiv(divName) {
          ...
          key: "clickToDownload",
          value: function clickToDownload() {
          ...
          value: function captureScreen() {
            ...
            html2canvas__WEBPACK_IMPORTED_MODULE_3___default()(data).then(function (canvas) {
              ...
              var pdf = new jspdf__WEBPACK_IMPORTED_MODULE_2__["default"]('p', 'mm', 'a4'); // A4 size page of PDF  
      ...
      TestPDFPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-test-pdf',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./test-pdf.page.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/test-pdf/test-pdf.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./test-pdf.page.scss */
        "./src/app/test-pdf/test-pdf.page.scss"))["default"]]
      })], TestPDFPage);
      /***/
    }
  }]);
