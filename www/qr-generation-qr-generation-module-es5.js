(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["qr-generation-qr-generation-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppQrGenerationQrGenerationPageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppQrGenerationQrGenerationRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "QrGenerationPageRoutingModule", function () {
        return QrGenerationPageRoutingModule;
      });
      /* harmony import */
      ...
      var _qr_generation_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./qr-generation.page */
      ...
      var QrGenerationPageRoutingModule = function QrGenerationPageRoutingModule() {
        _classCallCheck(this, QrGenerationPageRoutingModule);
      };

      QrGenerationPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function srcAppQrGenerationQrGenerationModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "QrGenerationPageModule", function () {
        return QrGenerationPageModule;
      });
      /* harmony import */
      ...
      var _qr_generation_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./qr-generation-routing.module */
      "./src/app/qr-generation/qr-generation-routing.module.ts");
      /* harmony import */


      var _qr_generation_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./qr-generation.page */
      "./src/app/qr-generation/qr-generation.page.ts");
      /* harmony import */


      var angular2_qrcode__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! angular2-qrcode */
      "./node_modules/angular2-qrcode/__ivy_ngcc__/lib/angular2-qrcode.js");

      var QrGenerationPageModule = function QrGenerationPageModule() {
        _classCallCheck(this, QrGenerationPageModule);
      };

      QrGenerationPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], angular2_qrcode__WEBPACK_IMPORTED_MODULE_7__["QRCodeModule"], _qr_generation_routing_module__WEBPACK_IMPORTED_MODULE_5__["QrGenerationPageRoutingModule"]],
    ...
    /***/
    function srcAppQrGenerationQrGenerationPageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppQrGenerationQrGenerationPageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "QrGenerationPage", function () {
      ...
      "./src/app/services/common.service.ts"); //  import { ExportExcelService } from '../services/export-excel.service';


      var QrGenerationPage = /*#__PURE__*/function () {
        // hide:boolean = false
        //  ,private ete: ExportExcelService
        function QrGenerationPage(http, formBuilder, router, ajaxService, commonService, platform) {
          var _this = this;

          _classCallCheck(this, QrGenerationPage);
          ...
          this.renewal = ['y', 'n'];
          this.values = [];
          this.commonService.loginMenuInfo.subscribe(function (res) {
            if (res) {
              console.log(res);
              _this.loginRes = res;
            }
        ...
        _createClass(QrGenerationPage, [{
          ...
          value: function submit() {
            ...
            var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["ServerUrl"].live + '/qrcodegeneration/save';
            var datas = this.qrform.value;
            ...
            if (this.qrform.valid) {
              this.ajaxService.ajaxPostWithBody(url, datas).subscribe(function (res) {
                if (Object.keys(res[0])[0] != 'errormessage' && res != []) {
                  console.log(res);
                  _this3.qrcodeUrl = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["ServerUrl"].live + '/qrcodegeneration/scan?QRCode='; // this.qrcodes(res)

                  _this3.commonService.dismissLoader();

                  _this3.qrform.reset();

                  _this3.commonService.presentToast('Generated Successfully'); //  let data =  window.open('http://localhost/QRCode/','popup','height=100,width=50')
                  //   if (window.focus) {data.focus()
                  //     return false;}


                  _this3.popitup(res[0].qrid); //  setTimeout(() => {
                  //   this.clickToDownload(res)
                  //   this.values = []
                  //  }, 1000);

                } else {
                  _this3.commonService.presentToast('something bad happened !!');
          ...
          key: "popitup",
          value: function popitup(id) {
            var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["ServerUrl"].live + '/dashboard/printqrcode?Qrid=' + id;
          ...
          value: function getBrand() {
            ...
            var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["ServerUrl"].live + "/dashboard/brand";
            this.ajaxService.ajaxGet(url).subscribe(function (res) {
              _this4.brand = res.value;
            });
          }
        }, {
          key: "clickToDownload",
          value: function clickToDownload(res) {
            // this.generatedcertificate();
            var printWindow = window.open('', '', 'height=1000,width=900');
            printWindow.document.write('<html>'); // printWindow.document.write('</body>')
            ...
            printWindow.print();
            printWindow.document.close(); // this.router.navigateByUrl('dashboard')
          }
        }, {
          key: "getrenewal",
          value: function getrenewal(ev) {
          ...
          key: "exportToExcel",
          value: function exportToExcel(res) {
            var pdfdatas = [];
          ...
          value: function getRtoList() {
            ...
            var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["ServerUrl"].live + "/dashboard/rtoList";
            this.ajaxService.ajaxGet(url).subscribe(function (res) {
              _this5.rto = JSON.parse(res.value);
            });
          }
        }, {
          key: "getUserId",
          value: function getUserId() {
            var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["ServerUrl"].live + '/qrcodegeneration/getuserid?MobileNo=' + this.qrform.value; //  this.ajaxService.ajaxPostWithBody(url, datas).subscribe(res=>{
            //   console.log(res)
            // })
          }
        }, {
          ...
          key: "convertToImage",
          value: function convertToImage(value, lotnumber) {
            var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["ServerUrl"].live + '/dashboard/printqrcode?RTOZone=' + this.values[0].subheader + '&LotNumber=' + this.values[0].lotnumber;
            this.ajaxService.ajaxGet(url).subscribe(function (res) {
              console.log(res);
            });
          }
          ...
          value: function getuserlist() {
            ...
            var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["ServerUrl"].live + "/dashboard/user/list";
            var datas = {
          ...
          value: function getProducts() {
            ...
            var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["ServerUrl"].live + "/dashboard/product";
            this.ajaxService.ajaxGet(url).subscribe(function (res) {
              _this7.productName = res.value;
            });
          }
        }, {
          key: "createForm",
      ...
      QrGenerationPage.ctorParameters = function () {
        return [{
      ...
      QrGenerationPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        selector: 'app-qr-generation',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./qr-generation.page.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/qr-generation/qr-generation.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./qr-generation.page.scss */
        "./src/app/qr-generation/qr-generation.page.scss"))["default"]]
      })], QrGenerationPage);
      /***/
    }
  }]);
})();
//# sourceMappingURL=qr-generation-qr-generation-module-es5.js.map