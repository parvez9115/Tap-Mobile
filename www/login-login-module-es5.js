(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["login-login-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppLoginForgotForgotComponentHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppLoginForgotForgotComponentScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppLoginForgotForgotComponentTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var ForgotComponent = /*#__PURE__*/function () {
        function ForgotComponent(storage, modalController, platform, commonService, formBuilder, ajaxService) {
        ...
        _createClass(ForgotComponent, [{
          ...
          value: function submit() {
            ...
            var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["ServerUrl"].live + 'user/forgetpassword?Email=' + this.cpassword.value.mailid;
            this.ajaxService.ajaxGet(url).subscribe(function (res) {
              ...
              if (res.message == "Invalid Email ID") {
                ...
                _this.commonService.presentToast('Updated Sucessfully');
      ...
      ForgotComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        "./node_modules/raw-loader/dist/cjs.js!./src/app/login/forgot/forgot.component.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./forgot.component.scss */
        "./src/app/login/forgot/forgot.component.scss"))["default"]]
      })], ForgotComponent);
      /***/
    },
    ...
    function srcAppLoginLoginModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      /*! @ionic/storage */
      "./node_modules/@ionic/storage/__ivy_ngcc__/fesm2015/ionic-storage.js"); // import { IonicSelectableModule } from 'ionic-selectable';
      ...
      LoginPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], _ionic_storage__WEBPACK_IMPORTED_MODULE_8__["IonicStorageModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], // IonicSelectableModule,
    ...
    function srcAppLoginLoginPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _services_ajax_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      ...
      /*! ./forgot/forgot.component */
      "./src/app/login/forgot/forgot.component.ts"); // import { IonicSelectableComponent } from 'ionic-selectable';


      var LoginPage = /*#__PURE__*/function () {
        function LoginPage(modalController, menuController, formBuilder, commonService, router, ajaxService, storage, platform) {
          var _this3 = this;
          ...
          this.showHidePass = function () {
            _this3.password_type = _this3.password_type === "text" ? "password" : "text";
            _this3.eye_icon = _this3.eye_icon === "eye" ? "eye-off" : "eye";
          };

          var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["ServerUrl"].live + "/dashboard/background";
          this.ajaxService.ajaxGet(url).subscribe(function (res) {
            _this3.background = res.value;
          });
          url = src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["ServerUrl"].live + "/dashboard/rtoList";
          this.ajaxService.ajaxGet(url).subscribe(function (res) {
            _this3.rtos = JSON.parse(res.value);
          });
        }
        ...
        _createClass(LoginPage, [{
          ...
          value: function submitLogin() {
            ...
            var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_8__["ServerUrl"].live + "/authentic/user";
            this.ajaxService.ajaxPostWithBody(url, body).subscribe(function (res) {
              ...
              if (res != null && res != "" && res.message != "Invalid User Name & Password.") {
                ...
                if (_this4.buttonName == "Rto Login" && res.role.roleName == "RTO") {
                  _this4.commonService.dismissLoader();

                  var msg = "!Oops.. You should be logged in rto login";

                  _this4.commonService.presentToast(msg);
                } else {
                  _this4.storage.set("loginRes", JSON.stringify(res)).then(function (res) {
                    _this4.commonService.updateLoginInfo(messagingServiceData);

                    if (_this4.pageSelection == "userLogin") {
                      _this4.router.navigateByUrl('/dashboard-count', {
                        replaceUrl: true
                      });

                      _this4.commonService.dismissLoader();
                    } else {
                      _this4.router.navigateByUrl('/rto-dashboard', {
                        replaceUrl: true
                      });
                    }
                  });
                ...
                if (_this4.commonService.isLoading) _this4.commonService.dismissLoader();
                var _msg = "Your logging credential is invalid ";

                _this4.commonService.presentToast(_msg);
              } else if (res.message) {
                if (_this4.commonService.isLoading) _this4.commonService.dismissLoader();

                _this4.commonService.presentToast(res.message);
              } else {
                if (navigator.onLine) {
                  if (_this4.commonService.isLoading) _this4.commonService.dismissLoader();
                  var _msg2 = "Oops! Server is in under maintenance";

                  _this4.commonService.presentToast(_msg2);
                } else {
                  if (_this4.commonService.isLoading) _this4.commonService.dismissLoader();
                  var _msg3 = "Oops! Connecting server error, Make sure your internet connection";

                  _this4.commonService.presentToast(_msg3);
                }
              }
            }); // } 
            // else {
