(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["dealer-certification-list-dealer-certification-list-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppDealerCertificationListDealerCertificationListPageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppDealerCertificationListDealerCertificationListRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "DealerCertificationListPageRoutingModule", function () {
        return DealerCertificationListPageRoutingModule;
      });
      /* harmony import */
      ...
      var _dealer_certification_list_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./dealer-certification-list.page */
      ...
      var DealerCertificationListPageRoutingModule = function DealerCertificationListPageRoutingModule() {
        _classCallCheck(this, DealerCertificationListPageRoutingModule);
      };

      DealerCertificationListPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function srcAppDealerCertificationListDealerCertificationListModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "DealerCertificationListPageModule", function () {
        return DealerCertificationListPageModule;
      });
      /* harmony import */
      ...
      var _dealer_certification_list_routing_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./dealer-certification-list-routing.module */
      "./src/app/dealer-certification-list/dealer-certification-list-routing.module.ts");
      /* harmony import */


      var _dealer_certification_list_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./dealer-certification-list.page */
      "./src/app/dealer-certification-list/dealer-certification-list.page.ts"); // import { DashboardPageRoutingModule } from './dashboard-routing.module';


      var DealerCertificationListPageModule = function DealerCertificationListPageModule() {
        _classCallCheck(this, DealerCertificationListPageModule);
      };

      DealerCertificationListPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _shared_module_shared_module__WEBPACK_IMPORTED_MODULE_5__["SharedModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _dealer_certification_list_routing_module__WEBPACK_IMPORTED_MODULE_6__["DealerCertificationListPageRoutingModule"]],
    ...
    /***/
    function srcAppDealerCertificationListDealerCertificationListPageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppDealerCertificationListDealerCertificationListPageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "DealerCertificationListPage", function () {
        return DealerCertificationListPage;
      });
      /* harmony import */
      ...
      var DealerCertificationListPage = /*#__PURE__*/function () {
        function DealerCertificationListPage(ajaxService, storage, commonService, formBuilder, platform) {
          _classCallCheck(this, DealerCertificationListPage);
        ...
        _createClass(DealerCertificationListPage, [{
          ...
          key: "ngOnChanges",
          value: function ngOnChanges() {// this.temp = this.member
          }
        }, {
          key: "ngOnInit",
          ...
          value: function submit(data) {
            ...
            if (this.formDate && this.toDate) {
              var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["ServerUrl"].live + "/dashboard/searchcertificate?Key=&KeyID=&FromDate=" + this.formDate.slice(0, 10) + "&ToDate=" + this.toDate.slice(0, 10) + "&offset=" + this.offset + "&limit=" + this.limit; // let url = ServerUrl.live + "/dashboard/searchcertificate?Key=QRCode&KeyID=16032022.2170-0&FromDate=2022-03-23&ToDate=2022-03-23Key=QRCodeKeyID=16032022.2170-0FromDate=2022-03-23ToDate=2022-03-23"+this.formDate+"&ToDate="+this.toDate;

              this.ajaxService.ajaxGet(url).subscribe(function (res) {
                console.log(res);
                _this.temp, _this.member = res;
              });
            } else {
          ...
          value: function selectedRowRecived(data) {
            console.log(data);
            this.offset = this.offset + data; // this.table.offset = 0;
            //  this.table.offset = 0;
            // this.offset = data
          ...
          value: function getLoginUserList(data) {
            var _this2 = this;
            ...
            this.storage.get('loginRes').then(function (result) {
              ...
              _this2.page = result["role"]["roleName"];
              var body = result; // if (this.page != "Dealer" && this.page != "RTO") {
              ...
              var url = src_environments_environment__WEBPACK_IMPORTED_MODULE_2__["ServerUrl"].live + "/dashboard/certificate/list?offset=" + _this2.offset + "&limit=" + _this2.limit;

              _this2.commonService.presentLoader();

              _this2.ajaxService.ajaxPostWithBody(url, body).subscribe(function (res) {
                // console.log(res)
                _this2.member = res;
                _this2.temp = _this2.member; //   if(data){
                ...
                _this2.storage.set("dashboardResult", JSON.stringify(res)).then(function (res) {});

                _this2.pdfTitle = ["Certificate id", "Registration no", "Name", "Vehicle Type", "Vehicle Modal", "Rto status"];

                for (var i = 0; i < _this2.member.length; i++) {
                  _this2.pdfData.push([res[i].certificateId, res[i].registrationNumber, res[i].ownerName, res[i].vehicleMake, res[i].vehicleModel, res[i].rtoStatus]);
                }
              }); //  }
      ...
      DealerCertificationListPage.ctorParameters = function () {
        return [{
      ...
      DealerCertificationListPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-dealer-certification-list',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./dealer-certification-list.page.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/dealer-certification-list/dealer-certification-list.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./dealer-certification-list.page.scss */
        "./src/app/dealer-certification-list/dealer-certification-list.page.scss"))["default"]]
      })], DealerCertificationListPage);
      /***/
    }
  }]);
})();
//# sourceMappingURL=dealer-certification-list-dealer-certification-list-module-es5.js.map