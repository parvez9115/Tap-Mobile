...
let CertificatesComponent = class CertificatesComponent {
    ...
    getRtoList() {
        const url = src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["ServerUrl"].live + "/dashboard/rtoList";
    ...
    submit(data) {
        ...
        const url = src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["ServerUrl"].live + "/dashboard/certificatereport?RTOZone=" + this.selectedRto + "&Mobileno=" + this.selectedDealer + "&FromDate=" + this.formDate + "&ToDate=" + this.toDate;
        this.ajaxService.ajaxGet(url)
            .subscribe(res => {
            this.memberList = res;
            console.log(res);
    ...
    getDealer() {
        const url = src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["ServerUrl"].live + "/dashboard/roleuser?key=Dealer";
        this.ajaxService.ajaxGet(url)
            .subscribe(res => {
            this.dealerList = res;
        });
...
CertificatesComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./certificates.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/reports/certificates/certificates.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./certificates.component.scss */ "./src/app/reports/certificates/certificates.component.scss")).default]
    })
...
/* harmony import */ var _certificates_certificates_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./certificates/certificates.component */ "./src/app/reports/certificates/certificates.component.ts");
...
/* harmony import */ var _rto_department_rto_department_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./rto-department/rto-department.component */ "./src/app/reports/rto-department/rto-department.component.ts");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RtoDepartmentComponent", function() { return RtoDepartmentComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
let RtoDepartmentComponent = class RtoDepartmentComponent {
    constructor(ajaxService, commonServices) {
        this.ajaxService = ajaxService;
    ...
    getDatas() {
        ...
        const url = src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["ServerUrl"].live + "/dashboard/rtodepartmentreport";
...
RtoDepartmentComponent.ctorParameters = () => [
...
RtoDepartmentComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-rto-department',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./rto-department.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/reports/rto-department/rto-department.component.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./rto-department.component.scss */ "./src/app/reports/rto-department/rto-department.component.scss")).default]
    })
